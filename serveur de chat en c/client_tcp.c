...
int main(int argc, char *argv[])
{
    ...
    // parcour de de toute les sockets filtré et connexion à la première socket trouvé
    ...
    {   //On caste la structure sockfd pour éviter les wannings
    ...
    for(;;)
    {
        ...
        fgets(sBuf, 100, stdin); // prend le méssage ;
